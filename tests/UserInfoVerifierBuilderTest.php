...
{
    protected function getBuilder(array $issuerMetadata, array $clientMetadata): UserInfoVerifierBuilder
    {
        return UserInfoVerifierBuilder::create($issuerMetadata, $clientMetadata);
    }
